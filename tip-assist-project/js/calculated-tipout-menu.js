...
function calcServerTipout(){
    const totalSales = parseFloat(document.getElementById('server-total-sales').querySelector('input').value);
    const foodSales = parseFloat(document.getElementById('server-total-foodsales').querySelector('input').value);     
    const drinkSales = parseFloat(document.getElementById('server-total-drinksales').querySelector('input').value);
    ...
    const bartenderTipoutLine1 = document.getElementById('server-bartender-tipout-calculated-percent1');
    const bartenderTipoutLine2 = document.getElementById('server-bartender-tipout-calculated-percent2');        
    const bartenderTipoutLine3 = document.getElementById('server-bartender-tipout-calculated-final');
    ...
    bartenderTipoutLine2.querySelector('label').textContent = 'x ' + bartenderTipoutPercentage;
    bartenderTipoutLine2.querySelector('input').value = (drinkSales * bartenderTipoutPercentage * bartenderTipoutPercentage).toFixed(2);
    bartenderTipoutLine3.querySelector('input').value = (drinkSales * bartenderTipoutPercentage * bartenderTipoutPercentage).toFixed(0);
}